<?php
  ...
  $work_experience = array(
    ...
    array('organisation' => 'External IT',
          'organisation_sub' => '',
          'position' => 'Network and Systems Administrator',
          'start_date' => 'May 2017',
          'end_date' => 'July 2017',
          'description' => 'External IT is a small Managed Service Provider (MSP) based in Townsville supporting nearly 400 devices across 16 clients. Whilst employed I be managed most aspects of the clients Information Technology infrastructure including desktops, laptops, mobile devices, printers, Windows servers running Active Directory, VMware, Exchange, DHCP, DNS, Print Management and more, server backups, networking (switches, routers, firewalls, wireless access points). This is in addition to any project work that arose for any client.',
          'tasks_list' => array(),
          'attachments_available' => false,
          'hidden' => false,
        ),
